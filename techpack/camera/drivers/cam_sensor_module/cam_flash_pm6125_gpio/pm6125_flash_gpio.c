...
void pm6125_flash_gpio_select_state(PM6125_FLASH_GPIO_STATE s, unsigned int periods, unsigned int percentage){
    struct pwm_state pstate;
    int rc = 0;

    pwm_get_state(pwm, &pstate);
    pstate.period = periods;
    pstate.duty_cycle = (periods * percentage)/100;
    switch(s){
